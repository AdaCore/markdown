...
package body Markdown.Blocks.HTML is

   ------------
   -- Adjust --
   ------------

   overriding procedure Adjust (Self : in out HTML_Block) is
   begin
   ...
   overriding procedure Finalize (Self : in out HTML_Block) is
   begin
      if Self.Data.Assigned then
   ...
   function From_Block (Self : Markdown.Blocks.Block)
     return HTML_Block is
   begin
      System.Atomic_Counters.Increment (Self.Data.Counter);

      return (Ada.Finalization.Controlled with Data =>
               HTML_Block_Access (Self.Data));
   end From_Block;
   ...
   function To_Block (Self : HTML_Block) return Markdown.Blocks.Block is
   begin
      return (Ada.Finalization.Controlled with Data =>
               Markdown.Implementation.Abstract_Block_Access (Self.Data));
   end To_Block;
